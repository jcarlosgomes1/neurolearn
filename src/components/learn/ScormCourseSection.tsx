  ...
  return (
    <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
      <h2 className="mb-3 flex items-center gap-2 text-sm font-semibold text-slate-800">
        <Package className="h-4 w-4 text-brand-600" /> {t('scormlearn.title')}
      </h2>
      <div className="space-y-2">
        {rows.map((p) => (
          <a
            ...
            className="flex items-center justify-between gap-3 rounded-xl border border-slate-200 p-3 transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md"
          >
