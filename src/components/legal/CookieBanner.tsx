          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-bold text-slate-900 text-sm flex items-center gap-2">
                <Settings2 className="h-4 w-4" /> Preferências de cookies
              </h3>
            ...
            <div className="space-y-2.5 mt-3">
              <CookieToggle title="Essenciais" desc="Necessários para o funcionamento básico (login, sessão)." enabled={true} disabled />
              <CookieToggle title="Funcionais" desc="Preferências de idioma, layout, conta."
                enabled={functional} onChange={setFunctional} />
              <CookieToggle title="Analytics" desc="Ajudam-nos a entender como usas o site (anónimo)."
                enabled={analytics} onChange={setAnalytics} />
              <CookieToggle title="Marketing" desc="Personalização de ofertas e remarketing."
