...
import { EnrollPathButton } from '@/app/[locale]/aprender/percursos/[slug]/EnrollPathButton';
...
export default async function PublicLearningPathDetailPage({ params }: { params: Promise<{ locale: string; slug: string }> }) {
    ...
    <>
      ...
      <main className="bg-white min-h-screen">
        <div className="max-w-5xl mx-auto px-4 py-8">
          <Link href={'/percursos' as any} className="text-sm text-slate-500 hover:text-slate-700 flex items-center gap-1 mb-4">
