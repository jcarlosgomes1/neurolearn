      ...
      <main className="bg-white min-h-screen">
        ...
        {enriched.length === 0 ? (
          <section className="max-w-3xl mx-auto px-4 py-16 text-center">
            ...
            <p className="text-lg text-slate-500">Ainda não há artigos publicados.</p>
          </section>
        ) : (
          <>
            {hero && hero.tr && (
                  ...
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="p-6 sm:p-10 flex flex-col justify-center">
                      ...
                      <div className="mt-6 flex items-center gap-3 text-sm text-slate-500">
                        ...
                        {hero.tr.reading_time_minutes && <><span>·</span><span>{hero.tr.reading_time_minutes} min</span></>}
                      </div>
                    </div>
                  </div>
                </Link>
                    ...
                    <Link key={p.id} href={`/blog/${p.slug}` as any} className="group flex flex-col bg-white rounded-xl overflow-hidden border border-slate-200 hover:border-slate-300 hover:shadow-lg transition-all duration-300">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <div className="mt-4 flex items-center gap-2 text-xs text-slate-500">
                          ...
                          {p.tr!.reading_time_minutes && <><span>·</span><span>{p.tr!.reading_time_minutes} min</span></>}
                        </div>
                      </div>
                    </Link>
                  ))}
