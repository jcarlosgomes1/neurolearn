...
// Paleta de acento agora vem dos tokens (CSS vars --<fam>-base/deep/soft), governados pela BD.
// Cada item escolhe uma família; a cor sai do token, não de classe cravada.
const FEATURES = [
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main className="min-h-screen" style={{ background: 'var(--paper)' }}>
      ...
      <div className="text-center pb-10 text-xs" style={{ color: 'var(--ink-3)' }}>preview · tokens de acento da BD · não toca no /para-estudantes real</div>
    </main>
  );
}
