  ...
  return (
    <div className="px-4 sm:px-6 py-6 max-w-5xl mx-auto">
      <div className="flex items-start justify-between gap-3 flex-wrap mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2"><Package className="h-6 w-6" /> Add-ons</h1>
          <p className="text-sm text-slate-500 mt-1">Produtos extra que orgs e instrutores podem comprar (AI credits, seats, white-label, SSO, etc).</p>
        </div>
