...
import { listInvoicesAction } from '../revenue/actions';
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const r: any = await listInvoicesAction();
  return <InvoicesClient initial={(r?.ok && Array.isArray(r.invoices)) ? r.invoices : []} />;
}
