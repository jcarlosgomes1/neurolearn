    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      <header className="mb-8 flex items-start justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Continua de onde paraste.</p>
        </div>
        <Link href={'/aprender/percursos' as any}
          ...
          <Sparkles className="h-4 w-4" /> Explorar percursos
        </Link>
      </header>
      ...
      {paths.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-1">Ainda não te inscreveste em nenhum percurso</h3>
          <p className="text-sm text-slate-500 mb-4">Os percursos guiam-te de A a Z com cursos curados.</p>
          <Link href={'/aprender/percursos' as any}
