...
export default async function OrgPathsPage({ params }: { params: Promise<{ slug: string; locale: string }> }) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Link href={{ pathname: '/empresa/[slug]', params: { slug } } as never}
      ...
      <header className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">{safeT('empresa.paths.title', 'Percursos para a equipa')}</h1>
