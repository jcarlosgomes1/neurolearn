...
export default async function AuthoringPage({ params }: { params: Promise<{ slug: string; locale: string }> }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <AppPageHeader eyebrow={safeT('academy.authoring.eyebrow', 'Academia · Autoria')} title={safeT('academy.authoring.page_title', 'Autoria de conteúdo')} description={safeT('academy.authoring.page_desc', 'Convoca especialistas internos para criar e validar formação — com reconhecimento.')} />
