        ...
        <section className="bg-gradient-to-br from-violet-600 to-brand-700 text-white">
          <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-semibold uppercase tracking-wider text-violet-200">{t('aff.program')}</span>
            </div>
            <h1 className="text-3xl sm:text-5xl font-bold mb-3">{t('aff.hero_title', { pct: data?.default_pct ?? 10 })}</h1>
            <p className="text-lg text-violet-100 max-w-2xl">{t('aff.hero_sub', { days: data?.cookie_days ?? 60 })}</p>
          </div>
        </section>
    ...
    <main className="bg-slate-50 min-h-screen">
      <section className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2"><Award className="h-6 w-6 text-violet-600" /> {t('aff.program')}</h1>
          <p className="text-sm text-slate-500 mt-1">{t('aff.code_label')}<code className="bg-slate-100 px-2 py-0.5 rounded font-mono text-slate-900">{aff.code}</code>{t('aff.commission_suffix', { pct })}</p>
        </div>
      </section>
