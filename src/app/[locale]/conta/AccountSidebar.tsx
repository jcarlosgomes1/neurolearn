...
import { User, Bell, Heart, Award, Sparkles, Shield, LogOut, BookOpen, Calendar, FileText, KeyRound, BellRing, Briefcase, GraduationCap, Route, CalendarClock, CalendarDays } from 'lucide-react';
  ...
  const GROUPS = [
    {
      items: [
        ...
        { href: '/conta/calendario', labelKey: 'account.item.calendar', fb: 'Calendário', icon: CalendarDays },
      ],
    },
    {
