  ...
  return (
    <>
      ...
      <main className="bg-white min-h-screen">
        <PageHeader badge="\u{1F4DA} Cat\u00e1logo completo" title="Todos os cursos" subtitle="Cursos profissionais criados por especialistas em IA. Pratica com casos reais, ao teu ritmo, com certificado verific\u00e1vel." />
