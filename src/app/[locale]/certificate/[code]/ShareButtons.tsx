...
export default function ShareButtons({
  ...
  const trackShare = () => {
    ...
    fetch(`${SUPABASE_URL}/rest/v1/rpc/nl_certificate_track_share`, {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-6">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <a href={linkedIn} target="_blank" rel="noopener noreferrer" onClick={trackShare}
        ...
        <a href={xUrl} target="_blank" rel="noopener noreferrer" onClick={trackShare}
          className="px-4 py-2 bg-black text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">
          𝕏  X
        </a>
        <a href={fb} target="_blank" rel="noopener noreferrer" onClick={trackShare}
